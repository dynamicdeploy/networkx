...
function loadMoArProducts() {
    $('ul#productlist').jscroll({
        loadingHtml: '<div align="center" style="margin: 20px 0 20px 0"><li id="feed_load"><img src="/Content/img/loader.gif" alt="ajax loading indicator" class="ajax-loader"> &nbsp; Loading more products...</li></div>',
        padding: 10,
